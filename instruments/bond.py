...
class ZeroCouponBond:
    def __init__(self, issue: Date, maturity: Date, par: InterestRate):
        self.issue = issue
        self.maturity = maturity
        self.par = par

    def compute_ytm(self, date: Date, price: InterestRate) -> InterestRate:
...
class Bond:
    ...
    def __init__(self, issue: Date, maturity: Date, par: InterestRate, face_value: InterestRate, coupons: list[Coupon]):
        self.issue = issue
        self.maturity = maturity
        self.par = par
    ...
    def compute_accruals(self, date: Date, price: InterestRate) -> InterestRate:
        pass
...
coupon = InterestRate(rate=InterestRate("0.00125"), compounding=Frequency.YEARLY, day_count=DayCount.ACTUAL_ACTUAL_ISDA)
