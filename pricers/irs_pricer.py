...
fixed_leg = FixedLeg(
    ...
    coupon=InterestRate(InterestRate("0.96495"), Frequency("SemiAnnual"), DayCount("30E/360")),
...
interest_rate = InterestRate(InterestRate("0.0014575"), Frequency("Yearly"), DayCount("30E/360"))
